                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="nombres" id="nombre" value="{{ old('nombres') }}" maxlength="50"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="apellidos" id="apellido" value="{{ old('apellidos') }}" maxlength="50"
                                        type="text" required="required" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="identificacion" value="{{ old('identificacion') }}" maxlength="10" type="text" class="form-control"
                                        placeholder="Ingresar Número de Cédula" required oninput="validarLongitud(this)"/>
                                </div>
                                {{-- FECHA DE NACIMIENTO --}}
                                <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="telefono" value="{{ old('telefono') }}" maxlength="10" type="text"
                                        required="required" class="form-control" placeholder="Ingresar Telefono" oninput="validarLongitud(this)" />
                                </div>
                                {{-- DIRECCION --}}
                                <div class="form-group col-md-6">
                                    <label class="control-label">Dirección</label>
                                    <input name="direccion" value="{{ old('direccion') }}" maxlength="50"
                                        type="text" required="required" class="form-control"
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" placeholder="Ingresar Correo Electronico" class="form-control" value="{{ old('email') }}" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="password" type="password"
                                        ...
                                        required autocomplete="current-password" placeholder="Ingresar Contraseña"> @error('password')
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="password" type="password"
                                        ...
                                        name="password_confirmation" required autocomplete="current-password" placeholder="Ingresar Nuevamente Contraseña">
                                </div>
                            </div>

                            <button class="btn btn-success pull-right" type="submit">Crear Usuario</button>
                        </div>
                    </div>
                </form>
            </div>
